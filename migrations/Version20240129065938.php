 ...
 */
final class Version20240129065938 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE content (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, text LONGTEXT NOT NULL, INDEX IDX_FEC530A9C54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
